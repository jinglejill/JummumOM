...
//打印数据(文字图片信息) Print data (text image information)
...
//Basic settings (including initialization, setting standard mode, horizontal and vertical motion units, default line spacing, setting font size)
- (void)basicSetting;
//打印文字
